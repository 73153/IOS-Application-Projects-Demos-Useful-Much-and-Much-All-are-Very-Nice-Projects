...
//  TesterSlide
//
//  Created by Heather Snepenger on 4/8/13.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.containerViewController = [[ContainerViewController alloc] initWithBaseViewController:mainVC andFirst:firstVC andSecond:secondVC];
